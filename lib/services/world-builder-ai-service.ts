...
export class WorldBuilderAIService {
  ...
  // Helper methods
  private parsePersonalityTraits(personality: string): any {
  ...
  private parseKnowledgeBase(areas: string[], aiKnowledge?: any): any[] {
  ...
  private parseEnvironmentSettings(atmosphere: string): any {
